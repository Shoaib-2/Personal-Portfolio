    ...
    <footer className="bg-background-card border-t border-border">
      <div className="section-container py-12">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          {/* Separator */}
          <span className="hidden md:block text-text-muted">•</span>
          ...
          >
            <a
              ...
              className="w-10 h-10 rounded-full bg-background-hover flex items-center justify-center hover:bg-accent-primary hover:scale-110 transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-background-hover flex items-center justify-center hover:bg-accent-blue hover:scale-110 transition-all"
            >
